/*
 * Copyright 2017-present, Mirko Justiniano.
 * All rights reserved.
 *
 * iDevCo.de
 */
...
function sendToBot(senderID, currentUser, message) {
  ...
  var aiRequest = bot.textRequest(message, {
    sessionId: senderID
  });
